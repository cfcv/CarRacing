...
arg_dict = {"horizon": 1000, "batch_size": 128, "buffer_size": 50000, "initial_collect_steps": 2000, "critic_lr": 3e-4, "actor_lr": 3e-4, "alpha_lr": 3e-4, "tau": 0.005, "gamma": 0.99, "actor_layers": (256,256), "summary_interval":10000, "num_eval_episodes":20, "critic_layers":(256,256), "reward_scale":1.0}

if(args.my_dict != None):
    for key, value in args.my_dict.items():
        if(key == 'tau' or key == 'gamma' or key == 'reward_scale' or key == "projection_std"):
